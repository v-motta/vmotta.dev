...
interface ZodIconProps extends SVGProps<SVGPathElement> {}

export function ZodIcon({ width, height, ...props }: ZodIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
